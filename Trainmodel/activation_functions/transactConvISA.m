...
num_subsamples_cfovea = isa1.num_subsamples;  % 8
patch_numel_sfovea = sfovea_spsize^2*sfovea_tpsize; % 2560
...
%     end
    ...
    %  blkidx(dim_p, it) when it=0, =1:300;    when it=1, = 301:600 .... so
