...
if load_layer_weights ==0 % when training the the first layer, we do not need to load layer bases
return;    
end

for i = 1:load_layer_weights
   bases_path_filename = fullfile(bases_path,[params.bases_id{i} '.mat']);
