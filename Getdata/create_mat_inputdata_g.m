function create_mat_inputdata_g(config, trainflag, valiflag, testflag)
...
% % % % %             load(savefilepath);
% % % % %             [~]=read_diffdepthvideo(modalityDepth);
% % % % %             continue
% % % % %         end
...
%         end
        %disp('Saving Skeleton and Label information ...... Finished!......1/5');
         if exist(savefilepath,'file')==2,
              load(savefilepath, 'modalityData'); 
         end
...
%         disp('Saving Grayscale information ...... Finished!......2/5');
        ...
        %modalityDepth=read_rawdepthvideo(modalityData,video_depthpath);
        %save(savefilepath, 'modalityDepth'); 
