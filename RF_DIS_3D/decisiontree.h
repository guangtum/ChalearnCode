...
typedef struct _tree_node
{
  ...
  int classNum;
  float ftrX, ftrY, ftrT, ftrWid, ftrHgt, ftrTwin;  // defines the cuboid region (3D)for the feature in this node
  vector<PMCUBOID> pmCuboids; // spatial pyramid configuration for this tree node
