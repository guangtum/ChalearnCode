...
def createDataSets(dataPath,trainPath,testPath,testPer):
    ...
    if os.path.exists(trainPath):
        ...
        for file in trainFileList:
            os.remove(os.path.join(trainPath,file));  # if there are some files in the trainpath, 
                                                      #we should remove these files and make the trainpath clean
    else:
...
def learnModel(data): # using the training data to learn a model
